# 👥 Contributing to Traits in typescript
...
- Browse [existing issues](https://github.com/HichemTab-tech/traits-in-ts/issues) to see if your issue or feature idea has already been raised.
- If your idea or issue hasn't been addressed, feel free to [create a new issue](https://github.com/HichemTab-tech/traits-in-ts/issues/new).
...
2. Clone your forked repository:
    ...
    ```sh
    git clone https://github.com/YOUR_GITHUB_USERNAME/traits-in-ts
    cd traits-in-ts
    ```
